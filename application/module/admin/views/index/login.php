                ...
                <div class="m">
                    <form action="<?= $linkAction?>" method="post" id="form-login">
                        <fieldset class="loginform">
                            ...
                            <input name="form[username]" id="mod-login-username" type="text" class="inputbox" size="15" value="<?= @$this->arrParam['form']['username']?>"/>
                            ...
                            <input name="form[token]" type="hidden" value="<?= time()?>" />
